  ...
  methods: {
    ...
    pointerForward() {
      ...
      if (this.pointer < this.filteredOptions.length - 1) {
        this.pointer++;
        if (((_a = this.$refs.list) == null ? void 0 : _a.scrollTop) <= this.pointerPosition - (this.visibleElements - 1) * this.optionHeight) {
    ...
    pointerBackward() {
      ...
      if (this.pointer > 0) {
        this.pointer--;
        if (((_a = this.$refs.list) == null ? void 0 : _a.scrollTop) >= this.pointerPosition) {
...
var _hoisted_3 = { class: "multiselect__tags-wrap" };
  ...
  return openBlock(), createElementBlock("div", {
    ...
    (openBlock(), createBlock(Teleport, {
      ...
      createVNode(Transition, { name: "multiselect" }, {
        default: withCtx(() => [
          _ctx.isOpen && $data.ready ? (openBlock(), createElementBlock(
            "div",
            {
              key: 0,
